...
def load_data(database_filepath):
    ...
    Returns:
        ...
        (DataFrame) Y: Dependent variables , array which contains lables to messages
        (DataFrame) category: Data Column Labels, a list with the target column names
    """
...
def build_model():
    ...
    that processes text messages according to the 
    NLP best practices and apply a classifier
    
    Returns:
        gs_cv(obj): an estimator which chains 
        together a nlp-pipeline with a 
